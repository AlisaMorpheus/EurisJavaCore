package it.euris.academy2023.frazionicache;
 ...
 * @author greppi
 */
public class FrazioneImmutabile implements Supplier{
     ...
     */
    public static FrazioneImmutabile getOrCreateIfAbsent(String frazione, Supplier<FrazioneImmutabile> supplier) {
        String f = frazione.trim();
        String[] tokens = f.split("/");
        return getOrCreateIfAbsent(Integer.parseInt(tokens[0]), Integer.parseInt(tokens[1]), supplier);
     ...
     * @return un'istanza di frazione
     */
    public static FrazioneImmutabile getOrCreateIfAbsent(int numeratore, int denominatore, Supplier<FrazioneImmutabile> supplier) {
    ...
    public static void main(String[] args) {
        ...
        FrazioneImmutabile f1 = FrazioneImmutabile.getOrCreateIfAbsent(1, 1, () -> new FrazioneImmutabile(1,1));
        System.out.println(f1.hashCode());
        /*
        FrazioneImmutabile f2 = FrazioneImmutabile.getOrCreateIfAbsent(2, 4);
        System.out.println(f2.hashCode());
        FrazioneImmutabile f3 = FrazioneImmutabile.getOrCreateIfAbsent(1, 2);
        System.out.println(f3.hashCode());
        FrazioneImmutabile f4 = FrazioneImmutabile.getOrCreateIfAbsent(12, 4);
        System.out.println(f4.hashCode());
        FrazioneImmutabile f5 = FrazioneImmutabile.getOrCreateIfAbsent(1, 2);
        System.out.println(f5.hashCode());
        FrazioneImmutabile f6 = FrazioneImmutabile.getOrCreateIfAbsent(125, 4);
